...
module.exports = { 
  ...
  onStart: async function ({ event, api, args }) { 
    ...
    const searchUrl = `https://global-redwans-rest-apis.onrender.com/api/animesearch?query=${query}`;
  ...
  onReply: async function ({ event, api, Reply }) { 
    ...
    const infoUrl = `https://global-redwans-rest-apis.onrender.com/api/animeinfo?url=${encodeURIComponent(selectedAnime.link)}`;
