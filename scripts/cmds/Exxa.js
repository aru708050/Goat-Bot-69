...
module.exports = {
  ...
  async onChat({ api, event, args }) {
    ...
    const apiUrl = `https://global-redwan-api-hoga-mara.onrender.com/aizen?prompt=${encodeURIComponent(q)}`;
  ...
  async onReply({ api, event }) {
    ...
    const apiUrl = `https://global-redwan-api-hoga-mara.onrender.com/aizen?prompt=${encodeURIComponent(reply)}`;
