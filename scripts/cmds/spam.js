...
module.exports = {
  config: {
    ...
    author: "Redwan",
    role: 2,
    shortDescription: "Spam text/media & auto-unsend after",
    longDescription: "Spams messages or media (if replied), waits 6s after all sent, then starts auto-unsending each message at random intervals (1-10s).",
    category: "sophia",
    guide: "{pn} [amount] [delay_ms] [message]\nReply to media/message to spam that\n{pn} stop"
  },
