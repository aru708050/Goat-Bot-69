...
module.exports = {
  ...
  onStart: async function ({ api, event, args, message }) {
    ...
    message.reply("Generating... Please wait.", async (err, info) => {
      ...
      try {
        const apiUrl = `https://global-redwans-rest-apis.onrender.com/api/generate-image?prompt=${encodeURIComponent(prompt)}&aspect_ratio=${encodeURIComponent(aspectRatio)}`;
