...
module.exports = {
  config: {
    name: "proxymidjourney",
    aliases: [ "pmj", "pjourney", "pj"],
    author: "Redwan",
    version: "2.0",
    cooldowns: 20,
    role: 2,
  ...
  onStart: async function ({ message, args, api, event }) {
    ...
    api.sendMessage("✨ | Initiating MidJourney's procces... Please be patient, this might take a moment.⏰", event.threadID, async (err, info) => {
      if (err) return;
